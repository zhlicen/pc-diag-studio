...
export const COPY = {
  zh: {
    ui: {
      ...
      advancedSensors: '高级传感器',
      sensors: {
        source: '自动来源',
        autoDetected: '自动检测到可用硬件传感器,已纳入诊断归因。',
        needsAdmin: '已检测到传感器来源,但读取需要管理员权限。',
        unavailable: '传感器来源暂不可用。',
        status: { ok: '已连接', denied: '需要管理员', failed: '读取失败' },
        providers: {
          auto: '自动检测',
          'dell-command-monitor': 'Dell Command | Monitor',
          'hwinfo-shared-memory': 'HWiNFO Shared Memory',
        },
        labels: {
          cpuTemp: 'CPU 温度',
          skinTemp: '机身温度',
  ...
  en: {
    ui: {
      ...
      sensors: {
        source: 'Auto Source',
        autoDetected: 'Hardware sensors were detected automatically and are included in attribution.',
        needsAdmin: 'A sensor source was detected, but reading it requires administrator access.',
        unavailable: 'The sensor source is currently unavailable.',
        status: { ok: 'Connected', denied: 'Needs admin', failed: 'Read failed' },
        providers: {
          auto: 'Auto detect',
          'dell-command-monitor': 'Dell Command | Monitor',
          'hwinfo-shared-memory': 'HWiNFO Shared Memory',
        ...
        labels: {
          ...
          skinTemp: 'Chassis Temperature',
          memoryTemp: 'Memory Temperature',
